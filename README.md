...
[![.NET](https://github.com/Yakusari/miningcore/actions/workflows/dotnet.yml/badge.svg)](https://github.com/Yakusari/miningcore/actions/workflows/dotnet.yml)
[![license](https://img.shields.io/github/license/mashape/apistatus.svg)]()

<img src="https://github.com/Yakusari/miningcore/raw/master/logo.png" width="150">
...
- Payment processing
- Banning System
- Live Stats [API](https://github.com/Yakusari/miningcore/wiki/API) on Port 4000
...
For general questions visit the [Discussions Area](https://github.com/Yakusari/miningcore/discussions).
...
- Download `miningcore-linux-ubuntu-x64.tar.gz` from the latest [Release](https://github.com/Yakusari/miningcore/releases)
- Extract the archive
- Setup the database as outlined below
- Create a configuration file `config.json` as described [here](https://github.com/Yakusari/miningcore/wiki/Configuration)
...
- Download `miningcore-win-x64.zip` from the latest [Release](https://github.com/Yakusari/miningcore/releases)
- Extract the Archive
- Setup the database as outlined below
- Create a configuration file `config.json` as described [here](https://github.com/Yakusari/miningcore/wiki/Configuration)
- Run `dotnet Miningcore.dll -c config.json`
...
```console
$ wget https://raw.githubusercontent.com/Yakusari/miningcore/master/src/Miningcore/Persistence/Postgres/Scripts/createdb.sql
...
```console
$ wget https://raw.githubusercontent.com/Yakusari/miningcore/master/src/Miningcore/Persistence/Postgres/Scripts/createdb_postgresql_11_appendix.sql
...
Please refer to this Wiki Page: https://github.com/Yakusari/miningcore/wiki/Configuration
...
$ git clone https://github.com/Yakusari/miningcore
...
Refer to [this file](https://github.com/Yakusari/miningcore/blob/master/src/Miningcore/coins.json) for a complete list.
...
Miningcore comes with an integrated REST API. Please refer to this page for instructions: https://github.com/Yakusari/miningcore/wiki/API
